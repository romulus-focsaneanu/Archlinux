...
sgdisk -n 1:0:+300M -c 1:"EFI" -t 1:ef00 /dev/nvme0n1
sgdisk -n 2:0:+170GB -c 2:"BTRFSROOT" -t 2:8300 /dev/nvme0n1
sgdisk -n 3:0:+291GB -c 3:"HOME" -t 3:8300 /dev/nvme0n1
sgdisk -n 4:0:"$ENDSECTOR" -c 4:"SWAP" -t 4:8200 /dev/nvme0n1
...
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvol=@snapshots /dev/nvme0n1p2 /mnt/.snapshots
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvol=@log /dev/nvme0n1p2 /mnt/var/log
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvol=@cache /dev/nvme0n1p2 /mnt/var/cache
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvol=@tmp /dev/nvme0n1p2 /mnt/var/tmp
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvol=@srv /dev/nvme0n1p2 /mnt/srv
mount -o noatime,ssd,compress=zstd,space_cache=v2,discard=async,subvolid=5 /dev/nvme0n1p2 /mnt/.btrfsroot
...
grub-install --target=x86_64-efi --efi-directory=/efi --boot-directory=/boot --bootloader-id=GRUB /dev/nvme0n1p2
