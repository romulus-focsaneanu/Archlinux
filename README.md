...
10. Once you get into the desktop you have to run post-install script. Archlinux folder containing the scripts; is in the /home directory. Copy post_install.sh from the Archlinux folder into the root of the /home directory. Set the permissions for the post-install script:
